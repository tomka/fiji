...
CLASSPATH(plugins/Jython_Interpreter.jar)=jars/ij.jar:jars/fiji-scripting.jar:jars/jython.jar:jars/snakeyaml-1.9.jar:jars/jxl.jar:jars/poi-3.7-20101029.jar:jars/poi-ooxml-3.7-20101029.jar:jars/jchart2d-3.2.2.jar
