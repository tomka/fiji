...
CLASSPATH(plugins/Jython_Interpreter.jar)=jars/ij.jar:jars/fiji-scripting.jar:jars/jython.jar:jars/snakeyaml-1.9.jar:jars/jxl.jar:jars/poi-3.8-20120326.jar:jars/poi-ooxml-3.8-20120326.jar:jars/jchart2d-3.2.2.jar:jars/icepdf-core.jar:jars/icepdf-viewer.jar:jars/omero_client.jar
